...
class EdukasiSosialExport implements FromCollection, WithHeadings, WithStyles, WithTitle, WithDrawings
{
    /**
    ...
    */
    public function collection()
    {
        ...
        return EdukasiSosial::select('petugas_id', 'nama_kegiatan', 'tempat', 'materi', 'point', 'orang', 'tanggapan', 'keterangan')->get();
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->setCellValue('A1', 'Data Edukasi Sosial');
    ...
    public function drawings()
{
    ...
    $logoKanan->setCoordinates('D1'); // Kanan atas sesuai posisi kolom akhir
